    ...
    <div class="row">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    <span style="width:85px" class="input-group-text"><b>{{__('Fecha')}}</b> </span>
                                    </div>
                                    <input type="text" class="form-control" value="{{$data[0]->fechaFactura}}" disabled>
                                    </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    <span style="width:180px" class="input-group-text"><b>{{__('Vencimiento')}}</b> </span>
                                    </div>
                                    <input type="text" class="form-control" value="{{$data[0]->Vencimiento}}" disabled>
                                    </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    <span style="width:180px" class="input-group-text"><b>{{__('Condiciones de Pago')}}</b> </span>
                                    </div>
                                    <input type="text" class="form-control" value="{{$data[0]->CondicionesDePago}}" disabled>
                                    </div>
        ...
        <div class="card-body">
            <div style="padding:20px;background-color: RGBA( 0 , 255 , 0 , 0.2 );" class="row">
                ...
                <div class="col-8"><b>{{__('Documento XML de Factura')}}</b><br><a class="btn btn-primary btn-xml" data-rfc="{{$data[0]->receptor}}" data-file="{{$data[0]->factura}}"> {{__('Visualizar XML')}}</a></div>
            </div>
            ...
            <hr>
            <div style="padding:20px; background-color:RGBA( 255 , 255 , 0 , 0.3 );">
                <form action="{{route('sup-upload-pdf', app()->getLocale())}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
            ...
            <div style="padding:20px;background-color: RGBA( 0 , 255 , 0 , 0.2 );" class="row">
                ...
                <div class="col-4"><a></a><img class="grow" src="/icons/pdf.png" width="60px" alt=""></div>
                <div class="col-8"><b>{{__('Documento PDF de Factura')}}</b><br><a class="btn btn-primary btn-file" onclick="cargarPDF('{{$data[0]->receptor}}/{{$_SESSION['usuario']->RFC}}/{{$data[0]->PDFsello}}.pdf')" > {{__('Visualizar PDF')}} </a> </div>
            </div>
